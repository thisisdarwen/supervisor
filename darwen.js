...
client.ayarlar = {
  "prefix": [".", "d", "!d", "d!"],
  "token": "TOKEN-BURAYA",
  "yapimci": ["852671058800803870"],
  "footer": "Darwen ❤️ ",
  "readyFooter": ["Darwen ❤️ "],
...
const sayiEmojiler = {
  0: `<a:darwen_sifir:780277947063468064>`, 
  1: `<a:darwen_bir:780277935810674748>`, 
  2: `<a:darwen_iki:780277898820976661>`, 
  3: `<a:darwen_uc:780277932630474802>`, 
  4: `<a:darwen_dort:780277894785794108>`, 
  5: `<a:darwen_bes:780277901755940895>`, 
  6: `<a:darwen_alti:780277924166500352>`, 
  7: `<a:darwen_yedi:780277954043314177>`, 
  8: `<a:darwen_sekiz:780277941455945729>`, 
  9: `<a:darwen_dokuz:780277951500648498>` 
};
...
function cezalandir(kisiID, tur) {
  client.guilds.cache.map(x => {
    ...
    if (tur == "ban") return uye.ban({ reason: "darwen Koruma" }).catch();
  });
};
