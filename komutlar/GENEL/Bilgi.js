...
exports.run = async (client, message, args) => {
  ...
  var durm = (Durum == "online" ? (`${client.emojis.cache.find(x => x.name === "darwen_online")} \`Çevrimiçi\``) : (Durum == "offline" ? (`${client.emojis.cache.find(x => x.name === "darwen_offline")} \`Çevrimdışı\``) : (Durum == "idle" ? (`${client.emojis.cache.find(x => x.name === "darwen_away")} \`Boşta\``) : (Durum == "dnd" ? (`${client.emojis.cache.find(x => x.name === "darwen_dnd")} \`Rahatsız Etmeyin\``) : ("Bilinmiyor/bulunamadı.")))));
